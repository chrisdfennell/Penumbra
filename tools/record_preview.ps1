...
# watch (the seconds column of binary dots ticking over). Run it AFTER the face
# is deployed and animating in the sim:
#
...
$outMp4 = Join-Path $PSScriptRoot "..\assets\CyberpunkBinary_preview.mp4"
